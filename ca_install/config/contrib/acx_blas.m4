...
dnl
dnl @version $1d: acx_f77blas.m4,v 1.2 2005/06/10 12:08:55 juselius Exp $
dnl @author Steven G. Johnson <stevenj@alum.mit.edu>
dnl
dnl Modified by Jonas Juselius <jonas@iki.fi>
dnl
dnl Tech-X version:
dnl    $Id: acx_blas.m4,v 1.1.1.1 2009/02/06 23:28:53 pteuben Exp $
dnl

AC_DEFUN([ACX_BLAS], [
dnl echo acx_blas called
AC_PREREQ(2.59)
...
case "$host" in
  *-apple-darwin*)
    acx_lapack_ok=yes
    acx_blas_libs='-framework Accelerate'
    ;;
esac
...
if test $acx_blas_ok = no; then
    unset ac_cv_lib_blas_sgemm
	AC_CHECK_LIB(blas, $sgemm,
	[acx_blas_ok=yes; acx_blas_libs="-framework Accelerate"],
